                    ...
                    {experiences.map((exp, index) => (
                        ...
                        >
                            ...
                            <div className="block md:hidden">
                                <div className={`p-6 rounded-lg transition-all duration-300 hover-scale ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-50 hover:bg-gray-100'}`}>
                                    {/* Date at top for mobile */}
                                    <div className="mb-4">
                                        <span className="inline-block px-3 py-1 bg-blue-600 text-white text-sm rounded-full font-medium">{exp.year}</span>
                                    </div>
